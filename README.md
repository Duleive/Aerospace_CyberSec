...
## Hack Fes 2026 「宇宙システムの攻防：事例分析とシミュレーションで学ぶ宇宙サイバーセキュリティ」に参加された方へ。
本講座に参加された方は、、[講座　リンク集](LINKS3.md)をご覧ください。
...
## 第９章につきまして
第９章のプログラミングのソースコードは、本書掲載のものでは下記の状況の変化により、エラーになります。
例に使う衛星をNOAA 15から、NOAA 20に変え、また、経過時間が長いのですべてのTLEを最新（2026年4月）に更新したソースコードがこちらになります。
[第9章のソースコード (修正・データの更新済)](sourcecode.md)
また、サンプルとして使ったTLEを抽出したものがこちらになります。
[プログラミングに使うデータ](sampleTLE.txt)

## 連続講座「宇宙サイバーセキュリティ入門講座」及び、本書を補足する、同人誌「航空機と衛星のサイバーセキュリティ入門II」の頒布

2026年3月20日夜７時より、オンラインで[宇宙サイバーセキュリティ講座　第０回：CYSATの報告と今後の講座の予告](https://aerospace.connpass.com/event/385431/)を開催しました。
また、4月3日より、連続5回の宇宙サイバーセキュリティ講座を無料で開催中です。詳しくは、[connpassのグループページ](https://aerospace.connpass.com/)をご覧ください。
講義の中で紹介したリファレンスは、[宇宙サイバーセキュリティ講座　リンク集](LINKS2.md)にて公開しています。

また、2026年4月11日、[技術書典20](https://techbookfest.org/event/tbf20)にて、本書を補足する、同人誌「航空機と衛星のサイバーセキュリティ入門II」を頒布しました。

[航空機と衛星のサイバーセキュリティ入門II 「空と宇宙のサイバーセキュリティ入門」補足](https://techbookfest.org/product/7wcHbwRP7xXEcfjbeCFGyB)
...
また、本書を出版後、新しい情報を補足するために、同人誌「航空機と衛星のサイバーセキュリティ入門II」を頒布しました。
